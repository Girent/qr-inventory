    ...
    <div class="modal-content shadow">
      ...
      <div class="modal-body">
        <form action="?id=<?=$value['id'] ?>" method="post">
			...
			<div class="form-group">
        		<input type="text" class="form-control" name="edit_mac" value="<?=$value['mac'] ?>" placeholder="Серийник">
        	</div>
			<div class="form-group">
        		<input type="text" class="form-control" name="edit_device" value="<?=$value['device'] ?>" placeholder="Устройство">
        	</div>
